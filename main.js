...
gsap.fromTo(".loading-page",{opacity:1,scale:1},{opacity:0,duration:5,ease,delay:5,y:-500});
gsap.fromTo(".name",{opacity:1,scale:1},{opacity:0,duration:5,ease,delay:5,y:-500 });
gsap.fromTo(".name1",{opacity:1,scale:1},{opacity:0,duration:5,ease,delay:5,y:-500 });
